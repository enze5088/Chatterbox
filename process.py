...
def cMedQA1():
    train_data = csv.reader(open("./data/QA/cMedQA-master/train_candidates.txt"))
    test_data = csv.reader(open("./data/QA/cMedQA-master/test_candidates.txt"))
    questions_data = csv.reader(open("./data/QA/cMedQA-master/questions.csv"))
    answers_data = csv.reader(open("./data/QA/cMedQA-master/answers.csv"))
    ...
    writer = open('./data/collect_datasets/cMedQA.txt', 'w')
    used_set = set()
...
def cMedQA2():
    train_data = csv.reader(open("./data/QA/cMedQA2-master/train_candidates.txt"))
    test_data = csv.reader(open("./data/QA/cMedQA2-master/test_candidates.txt"))
    questions_data = csv.reader(open("./data/QA/cMedQA2-master/question.csv"))
    answers_data = csv.reader(open("./data/QA/cMedQA2-master/answer.csv"))
    ...
    writer = open('./data/collect_datasets/cMedQA2.txt', 'w')
    used_set = set()
    title = train_data.__next__()
    for line in train_data:
        que_id = line[0]
...
def webMedQA():
    writer = open('./data/collect_datasets/webMedQA.txt', 'w')
    train_in = csv.reader(open("./data/QA/webMedQA-master/medQA.train.txt"), delimiter='\t')
    count = 0
    count2 = 0
    ...
    test_in = csv.reader(open("./data/QA/webMedQA-master/medQA.test.txt"), delimiter='\t')
    ...
    valid_in = csv.reader(open("./data/QA/webMedQA-master/medQA.valid.txt"), delimiter='\t')
...
def baike_qa2019():
    ...
    writer = open('./data/collect_datasets/{}.txt'.format(datasets_name), 'w')
    train_in = open("./data/QA/baike_qa2019/baike_qa_train.json")
    ...
    valid_in = open("./data/QA/baike_qa2019/baike_qa_valid.json")
...
def cluener_public_NER():
    ...
    base_dir = './data/NER/cluener_public/'
...
def bq_corpus():
    datasets_name = sys._getframe().f_code.co_name
    writer = open('./data/collect_datasets/{}.txt'.format(datasets_name), 'w')
    base_dir = "./data/STS/{}/".format(datasets_name)
...
def wiki_zh():
    datasets_name = sys._getframe().f_code.co_name
    writer = open('./data/collect_datasets/{}.txt'.format(datasets_name), 'w')
    base_dir = "./data/QA/{}/".format(datasets_name)
...
def alpaca_gpt4_data_zh():
    datasets_name = sys._getframe().f_code.co_name
    writer = open('./data/collect_datasets/{}.txt'.format(datasets_name), 'w')
    base_dir = "./data/{}/{}.json".format(datasets_name, datasets_name)
    fin = open(base_dir)
    data = fin.readlines()
...
def Belle():
    datasets_name = sys._getframe().f_code.co_name
    writer = open('./data/collect_datasets/{}.txt'.format(datasets_name), 'w')
    names = os.listdir("./data/{}/".format(datasets_name))
    for name in names:
        print(name)
        if 'README.md' == name:
            continue
        base_dir = "./data/{}/{}".format(datasets_name, name)
        fin = open(base_dir)
        max_len = 0
        max_ans = ''
...
def firefly():
    datasets_name = sys._getframe().f_code.co_name
    writer = open('./data/collect_datasets/{}.txt'.format(datasets_name), 'w')
    base_dir = "./data/{}/firefly-train-1.1M.jsonl".format(datasets_name)
    fin = open(base_dir)
    max_len = 0
    max_ans = ''
    for line in tqdm(fin):
